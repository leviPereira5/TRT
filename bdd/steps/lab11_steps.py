"""
Behave step definitions for lab11.feature
Run with: behave bdd/features/lab11.feature (from trt_project/ with Django configured)

Requires: pip install behave django-behave
"""
import os
import django
...
# Django setup for standalone Behave execution
...
def step_check_zero_variation(context):
    assert context.variation == Decimal("0.00"), \
        f"Esperado 0.00, obtido {context.variation}"
